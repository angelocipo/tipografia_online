...
module.exports = async (req, res) => {
  ...
  try {
    const { productId, tierIndex, sizeIndex, formula, deliveryIndex, customer, shipping, sender, shippingFee, shippingZone, designLink, designFiles, designRef } = req.body || {};
    ...
    metadata.design_ref = typeof designRef === 'string' ? designRef.slice(0, 40) : '';
